...
%% video frames
video_name = 'singer';
video_path = fullfile('D:\CResearch\datasets\MyBenchmark/',video_name);

video_path = [video_path '\img\'];
m_start_frame = 141;  %starting frame number
nframes		=210; %393;	 %number of frames to be tracked
...
m_boundingbox = [448	89	31	146];  % [left-top-x, left-top-y, width, height];
...
opt.rel_std_afnv =  [0.005,0.0005,0.0005,0.02,5,5]; % affine parameters for particle sampling
