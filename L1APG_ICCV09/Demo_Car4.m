...
switch title
    case 'car4'
        fprefix		= 'D:\CResearch\datasets\MyBenchmark\Car4\img\';
...
[tracking_res,output,resCenters,resConers]  = L1TrackingBPR_APGup(s_frames, para);
...
%         [resCenter,resRectangle]= drawAffine(map_afnv, sz_T, color, 2);%draw tracking result on the figure
%         drawnow
%         
%         resCenters = [resCenters,resCenter];
%         resRectangles = [resRectangles,resRectangle];
...
save([res_path title '_L1_APG_Centers' num2str(times) '.mat'], 'resCenters');
save([res_path title '_L1_APG_Coners' num2str(times) '.mat'], 'resConers');
